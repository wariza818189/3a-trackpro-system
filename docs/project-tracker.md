...
Follow-up POs, the Pending Purchase Orders Report, and the Unfulfilled Items Report are complete. Damage handling and the Damaged Items Report remain outstanding.
...
| PROCUREMENT | Damaged Item Recording | Record damaged quantities during PO receiving without adding damaged quantity to sellable stock. | TBD | — | — | Not Started | Working damaged-receiving evidence workflow | Maps to #30 / expansion item #8. Damage is receiving evidence. It must not create a RESTOCK movement or increase sellable stock. |
...
| REPORTS | Damaged Items Report | Display damaged-item history from PO receiving evidence. | TBD | — | — | Not Started | Working damaged-items report | Maps to #31 / expansion item #9. Depends on the future damaged-receiving source of truth. |
