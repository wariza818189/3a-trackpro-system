...
Follow-up POs, the Pending Purchase Orders Report, and the Unfulfilled Items
Report are complete. #30 damaged receiving is complete; the separate #31
Damaged Items Report remains outstanding.
...
| REPORTS | Damaged Items Report | Display damaged-item history from PO receiving evidence. | TBD | — | — | Not Started | Working damaged-items report | Maps to #31 / expansion item #9. The #30 receiving evidence source is complete; the separate Admin report remains Not Started. |
