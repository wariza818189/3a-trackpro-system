...
Product Sales grouped amount reconciliation with Sales Summary's completed-sales monetary total passed for the same date range and population. Bounded-query verification observed one SaleItem SELECT for 12 Product/Variant groups. No schema or migration change was made, and MySQL was not run.
